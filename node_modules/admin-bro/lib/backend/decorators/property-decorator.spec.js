...
describe('PropertyDecorator', function () {
  ...
  fields.forEach(field => {
    describe(`#${field}`, function () {
      it('passess the execution to the overrideFromOptions', function () {
        ...
        new _propertyDecorator.default(args)[field](); // for some reason chai dont know that calledWith is a property
  ...
  describe('#label', function () {
    it('returns camelcased name', function () {
      ...
      (0, _chai.expect)(new _propertyDecorator.default(args).label()).to.equal('Normalname');
    });
  });
