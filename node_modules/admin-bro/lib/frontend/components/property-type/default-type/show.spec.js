...
const renderTestSubject = (property, record, resource) => (0, _reactTestingLibrary.render)(_react.default.createElement(_testContextProvider.default, null, _react.default.createElement(_show.default, {
  property: property,
  record: record,
  resource: resource
})));
